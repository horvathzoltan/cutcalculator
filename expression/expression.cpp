...
//     case KeyWord::qty_fixed:    return Function::qtyFixed(_params);
//     case KeyWord::qty_perOrder: return Function::qtyPerOrder(_params);
//     case KeyWord::qty_perArea:  return Function::qtyPerArea(_params);
